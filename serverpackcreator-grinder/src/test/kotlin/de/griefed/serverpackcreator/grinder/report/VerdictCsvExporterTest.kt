...
internal class VerdictCsvExporterTest {
    ...
    fun emitsHeaderAndOrdersHighestConfidenceFirst() {
        ...
        val lines = csv.lines()
        Assertions.assertEquals("Name,Project,NamePattern,Confidence,Loader,Detail,Rule,Dependencies,Scanned", lines[0])
    ...
    fun emptyVerdictsStillEmitTheHeader() {
        Assertions.assertEquals("Name,Project,NamePattern,Confidence,Loader,Detail,Rule,Dependencies,Scanned", VerdictCsvExporter.toCsv(emptyList()))
    }
}
