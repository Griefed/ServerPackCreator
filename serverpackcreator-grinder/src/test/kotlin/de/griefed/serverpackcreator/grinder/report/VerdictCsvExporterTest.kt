...
internal class VerdictCsvExporterTest {
    ...
    fun emitsHeaderAndOrdersConfirmationsFirst() {
        ...
        val lines = csv.lines()
        Assertions.assertEquals("Name,Project,NamePattern,Filename,Verdict,Declared,Loader,Platform,ProjectSideness,JarSideness,Detail,Rule,Decision,Dependencies,Scanned", lines[0])
    ...
    fun emptyVerdictsStillEmitTheHeader() {
        Assertions.assertEquals("Name,Project,NamePattern,Filename,Verdict,Declared,Loader,Platform,ProjectSideness,JarSideness,Detail,Rule,Decision,Dependencies,Scanned", VerdictCsvExporter.toCsv(emptyList()))
    }
}
