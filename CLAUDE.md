...
**Current status (2026-09-23).** Counts are a snapshot and go stale — re-derive them from
...
|----------------|---------------|------------------------------------------------------------------|
| api            | 473 (1 skip)  | Phase 1 complete. → `serverpackcreator-api/CLAUDE.md` |
| clientside     | 671           | The clientside-mod verification engine; six verdicts. → `serverpackcreator-clientside/CLAUDE.md` |
| app            | 214           | Phase 2 largely complete; CLI verbs stay, engine extracted out. → `serverpackcreator-app/CLAUDE.md` |
...
| web-frontend   | 35 (from 0)   | Phase 4a-4e complete; full TS migration. → `serverpackcreator-web-frontend/CLAUDE.md` |
