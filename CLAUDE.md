...
| app            | 88            | Phase 2 largely complete; clientside engine extracted out, CLI verbs stay; + `VersionCheckerTest` (was untested) and a pin on `MigrationManager.LAMBDA_SUFFIX` |
