...
public class CreateServerPack extends Component  {
    ...
    JComponent createServerPack() {
        ...
        buttonJavaPath.setToolTipText("Load a config from a URL. URL must be a direct link to a serverpackcreator.conf file.");
        buttonJavaPath.setIcon(ReferenceGUI.loadIcon);
        buttonJavaPath.setPreferredSize(ReferenceGUI.miscButtonDimension);
