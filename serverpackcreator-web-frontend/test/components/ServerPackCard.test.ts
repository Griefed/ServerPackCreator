 ...
 * card copies off the response) and the size rendering. Added retroactively for the
 * untested card.
 */
describe('ServerPackCard', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    serverPackPayload = { dateCreated: 0, sha256: 'deadbeef', size: 524288, downloads: 5, confirmedWorking: -1 }
  })
