...
public class VersionCheckerTests {
    ...
    void gitLabCheckTests() {
        try {
            GitLabChecker gitLabChecker = new GitLabChecker(new LocalizationManager(),"https://gitlab.com/api/v4/projects/32677538/releases");
    ...
    void gitGriefedTest() {
        try {
            GitLabChecker gitLabChecker = new GitLabChecker(new LocalizationManager(),"https://git.griefed.de/api/v4/projects/63/releases");
