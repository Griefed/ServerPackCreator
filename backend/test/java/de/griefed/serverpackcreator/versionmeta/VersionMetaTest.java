...
/*        ServerPackCreator SERVER_PACK_CREATOR = new ServerPackCreator(new String[]{"--setup"});
    ...
    void minecraft() {
        ...
        Assertions.assertEquals(VERSIONMETA.minecraft().releaseVersionsArrayDescending().length,VERSIONMETA.minecraft().releaseVersionsDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().releaseVersionsArrayDescending()[0],
                VERSIONMETA.minecraft().releaseVersionsArrayAscending()[VERSIONMETA.minecraft().releaseVersionsArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.minecraft().releaseVersionsArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().releaseVersionsArrayAscending().length,VERSIONMETA.minecraft().releaseVersionsAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().releaseVersionsArrayAscending()[0],
                VERSIONMETA.minecraft().releaseVersionsArrayDescending()[VERSIONMETA.minecraft().releaseVersionsArrayDescending().length-1]
        );
        ...
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotVersionsArrayDescending().length,VERSIONMETA.minecraft().snapshotsVersionsDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotVersionsArrayDescending()[0],
                VERSIONMETA.minecraft().snapshotVersionsArrayAscending()[VERSIONMETA.minecraft().snapshotVersionsArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.minecraft().snapshotVersionsArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotVersionsArrayAscending().length,VERSIONMETA.minecraft().snapshotVersionsAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotVersionsArrayAscending()[0],
                VERSIONMETA.minecraft().snapshotVersionsArrayDescending()[VERSIONMETA.minecraft().snapshotVersionsArrayDescending().length-1]
        );
        VERSIONMETA.minecraft().releasesDescending().forEach(release -> {
            Assertions.assertNotNull(release);
            Assertions.assertNotNull(release.version());
            ...
            if (release.forge().isPresent()) {
                release.forge().get().forEach(forgeInstance -> {
        ...
        VERSIONMETA.minecraft().releaseVersionsAscending().forEach(mcVer -> Assertions.assertTrue(VERSIONMETA.minecraft().getClient(mcVer).isPresent()));
        Assertions.assertNotNull(VERSIONMETA.minecraft().releasesArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().releasesArrayAscending().length,VERSIONMETA.minecraft().releasesAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().releasesArrayAscending()[0],
                VERSIONMETA.minecraft().releasesArrayDescending()[VERSIONMETA.minecraft().releasesArrayDescending().length-1]
        );
        ...
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotsArrayDescending().length,VERSIONMETA.minecraft().snapshotsDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotsArrayDescending()[0],
                VERSIONMETA.minecraft().snapshotsArrayAscending()[VERSIONMETA.minecraft().snapshotsArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.minecraft().snapshotsArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotsArrayAscending().length,VERSIONMETA.minecraft().snapshotsAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotsArrayAscending()[0],
                VERSIONMETA.minecraft().snapshotsArrayDescending()[VERSIONMETA.minecraft().snapshotsArrayDescending().length-1]
        );
        ...
        Assertions.assertEquals(VERSIONMETA.minecraft().releasesServersArrayDescending().length,VERSIONMETA.minecraft().releasesServersDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().releasesServersArrayDescending()[0],
                VERSIONMETA.minecraft().releasesServersArrayAscending()[VERSIONMETA.minecraft().releasesServersArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.minecraft().releasesServersArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().releasesServersArrayAscending().length,VERSIONMETA.minecraft().releasesServersAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().releasesServersArrayAscending()[0],
                VERSIONMETA.minecraft().releasesServersArrayDescending()[VERSIONMETA.minecraft().releasesServersArrayDescending().length-1]
        );
        ...
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotsServersArrayDescending().length,VERSIONMETA.minecraft().snapshotsServersDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotsServersArrayDescending()[0],
                VERSIONMETA.minecraft().snapshotsServersArrayAscending()[VERSIONMETA.minecraft().snapshotsServersArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.minecraft().snapshotsServersArrayAscending());
        Assertions.assertEquals(VERSIONMETA.minecraft().snapshotsServersArrayAscending().length,VERSIONMETA.minecraft().snapshotsServersAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.minecraft().snapshotsServersArrayAscending()[0],
                VERSIONMETA.minecraft().snapshotsServersArrayDescending()[VERSIONMETA.minecraft().snapshotsServersArrayDescending().length-1]
        );
    }
    ...
    void forge() {
        ...
        Assertions.assertFalse(VERSIONMETA.forge().getForgeInstance("1.18.2","40.0123.45").isPresent());
        ...
        VERSIONMETA.forge().forgeVersions().forEach(forgeVersion -> {
            ...
            Assertions.assertNotNull(VERSIONMETA.forge().getForgeInstance(forgeVersion).get().forgeVersion());
            Assertions.assertNotNull(VERSIONMETA.forge().getForgeInstance(forgeVersion).get().minecraftVersion());
            Assertions.assertNotNull(VERSIONMETA.forge().getForgeInstance(forgeVersion).get().installerUrl());
            Assertions.assertNotNull(VERSIONMETA.forge().getForgeInstance(forgeVersion).get().minecraftClient());
        });
        VERSIONMETA.forge().minecraftVersionsAscending().forEach(minecraftVersion -> {
            Assertions.assertTrue(VERSIONMETA.forge().getForgeInstances(minecraftVersion).isPresent());
            VERSIONMETA.forge().getForgeInstances(minecraftVersion).get().forEach(instance -> {
        ...
        VERSIONMETA.forge().minecraftVersionsDescending().forEach(minecraftVersion -> {
            Assertions.assertTrue(VERSIONMETA.forge().getForgeInstances(minecraftVersion).isPresent());
        ...
        Assertions.assertEquals(VERSIONMETA.forge().minecraftVersionsArrayAscending().length,VERSIONMETA.forge().minecraftVersionsAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.forge().minecraftVersionsArrayAscending()[0],
                VERSIONMETA.forge().minecraftVersionsArrayDescending()[VERSIONMETA.forge().minecraftVersionsArrayDescending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.forge().minecraftVersionsArrayDescending());
        Assertions.assertEquals(VERSIONMETA.forge().minecraftVersionsArrayDescending().length,VERSIONMETA.forge().minecraftVersionsDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.forge().minecraftVersionsArrayDescending()[0],
                VERSIONMETA.forge().minecraftVersionsArrayAscending()[VERSIONMETA.forge().minecraftVersionsArrayAscending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.forge().availableForgeVersionsAscending("1.16.5").get());
        Assertions.assertTrue(VERSIONMETA.forge().availableForgeVersionsAscending("1.16.5").isPresent());
        Assertions.assertFalse(VERSIONMETA.forge().availableForgeVersionsAscending("1.16.5123").isPresent());
        Assertions.assertNotNull(VERSIONMETA.forge().availableForgeVersionsDescending("1.16.5").get());
        Assertions.assertTrue(VERSIONMETA.forge().availableForgeVersionsDescending("1.16.5").isPresent());
        Assertions.assertFalse(VERSIONMETA.forge().availableForgeVersionsDescending("1.16.5123").isPresent());
        Assertions.assertNotNull(VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").get());
        Assertions.assertTrue(VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").isPresent());
        Assertions.assertFalse(VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5123").isPresent());
        Assertions.assertEquals(VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").get().length,VERSIONMETA.forge().availableForgeVersionsAscending("1.16.5").get().size());
        Assertions.assertEquals(
                VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").get()[0],
                VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").get()[VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").get().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").get());
        Assertions.assertTrue(VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").isPresent());
        Assertions.assertFalse(VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5123").isPresent());
        Assertions.assertEquals(VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").get().length,VERSIONMETA.forge().availableForgeVersionsDescending("1.16.5").get().size());
        Assertions.assertEquals(
                VERSIONMETA.forge().availableForgeVersionsArrayDescending("1.16.5").get()[0],
                VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").get()[VERSIONMETA.forge().availableForgeVersionsArrayAscending("1.16.5").get().length-1]
        );
    ...
    void fabric() {
        ...
        Assertions.assertEquals(VERSIONMETA.fabric().installerVersionsArrayAscending().length,VERSIONMETA.fabric().installerVersionsAscending().size());
        Assertions.assertEquals(
                VERSIONMETA.fabric().installerVersionsArrayAscending()[0],
                VERSIONMETA.fabric().installerVersionsArrayDescending()[VERSIONMETA.fabric().installerVersionsArrayDescending().length-1]
        );
        Assertions.assertNotNull(VERSIONMETA.fabric().installerVersionsArrayDescending());
        Assertions.assertEquals(VERSIONMETA.fabric().installerVersionsArrayDescending().length,VERSIONMETA.fabric().installerVersionsDescending().size());
        Assertions.assertEquals(
                VERSIONMETA.fabric().installerVersionsArrayDescending()[0],
                VERSIONMETA.fabric().installerVersionsArrayAscending()[VERSIONMETA.fabric().installerVersionsArrayAscending().length-1]
        );
        ...
        VERSIONMETA.fabric().installerVersionsAscending().forEach(version -> {
