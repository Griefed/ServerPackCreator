...
class ServerPackModelHandlerTest {
    ...
    ServerPackModelHandlerTest() {
        ...
        this.SERVERPACKHANDLER = new ServerPackHandler(LOCALIZATIONMANAGER, CURSECREATEMODPACK, CONFIGURATIONHANDLER, APPLICATIONPROPERTIES, VERSIONLISTER, UTILITIES, PLUGINMANAGER);
