 ...
 * these games contained. Additional thanks to Larsz for providing a list of all these messages <a
 * href=https://gamefaqs.gamespot.com/pc/561176-simcity-4/faqs/22135>on GameFAQs </a>
 *
 * @author Griefed
 */
public class ReticulatingSplines {
   ...
   */
  public final String[] RETICULATING =
      new String[] {
  ...
  /**
   * Retrieves a message from {@link #RETICULATING} using a randomly generated index from {@link
   * #getRandomIntReticulating()}.
   *
