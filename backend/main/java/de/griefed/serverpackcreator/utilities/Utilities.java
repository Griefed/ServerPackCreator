...
public class Utilities {
    ...
    @Autowired
    public Utilities(LocalizationManager injectedLocalizationManager, ApplicationProperties injectedApplicationProperties,
                     VersionLister injectedVersionLister) {

        this.BOOLEAN_UTILITIES = new BooleanUtilities(injectedLocalizationManager, injectedApplicationProperties);
        ...
        this.CONFIG_UTILITIES = new ConfigUtilities(injectedLocalizationManager,BOOLEAN_UTILITIES,LIST_UTILITIES,injectedApplicationProperties,STRING_UTILITIES,injectedVersionLister);
    }
    ...
    public ConfigUtilities ConfigUtils() {
        return CONFIG_UTILITIES;
    }
