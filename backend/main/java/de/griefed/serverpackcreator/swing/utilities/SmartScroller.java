...
/**
 * Hey, Griefed here. I was playing around with scrolling in Swing and was getting fed up with the
 * ways I came up with which would allow me to set the scrollbar to the bottom at all times....I
 * mean, it worked, sorta? The problem was that you couldn't scroll up...making any previous log
 * messages unreadable...I couldn't figure out how to make it, so it would stop scrolling to the end
 * if the user scrolled up, and when I was about to give up and just not deal with any of that
