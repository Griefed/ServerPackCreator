...
public class ForgeMeta {
    ...
    /**
     * Get the list of Forge supported Minecraft versions, with either {@link Type#ASCENDING} or {@link Type#DESCENDING}
     * order.
     * @author Griefed
     * @param order {@link Type} The order of the resulting list. Either {@link Type#ASCENDING} or {@link Type#DESCENDING}.
     * @return {@link String}-list Forge supported Minecraft versions, in either {@link Type#ASCENDING} or {@link Type#DESCENDING}
     * order.
     */
    ...
    /**
     * Get the list of available Forge versions, with either {@link Type#ASCENDING} or {@link Type#DESCENDING} order.
     * @author Griefed
     * @param order {@link Type} The order of the resulting list. Either {@link Type#ASCENDING} or {@link Type#DESCENDING}.
     * @return {@link String}-list Forge versions, in either {@link Type#ASCENDING} or {@link Type#DESCENDING} order.
     */
    ...
    /**
     * Get an array of available Forge version for a given Minecraft version, either {@link Type#ASCENDING} or
     * {@link Type#DESCENDING}, wrapped in an {@link Optional}.
     * @author Griefed
     ...
     * @return {@link String}-array of available Forge versions for the given Minecraft version, either
    ...
    private Optional<String[]> getForgeVersionsArray(String minecraftVersion, Type order) {
        ...
        if (order == Type.DESCENDING) {
            return Optional.of(Lists.reverse(forgeLoader.versionMeta().get(minecraftVersion)).toArray(new String[0]));
        } else {
    ...
    /**
     * Get a list of available Forge version for a given Minecraft version, with either {@link Type#ASCENDING} or
     * {@link Type#DESCENDING} order.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @param order {@link Type} The order of the resulting list. Either {@link Type#ASCENDING} or {@link Type#DESCENDING}.
     * @return {@link String}-list of available Forge versions for the given Minecraft version, with either
     ...
     * @return {@link Boolean} <code>true</code> if the given Forge version is valid/supported/available.
     */
     ...
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link Boolean} <code>true</code> if the given Minecraft version is valid/supported/available.
     */
     ...
     * @param minecraftVersion {@link String} Minecraft version.
     * @param forgeVersion {@link String} Forge version.
     * @return {@link Boolean} <code>true</code> if the given Minecraft and Forge versions are valid/supported/available.
     */
     ...
     * @param minecraftVersion {@link String} Minecraft version.
     * @param forgeVersion {@link String} Forge version.
     * @return {@link Boolean} <code>true</code> if Forge is available for the given Forge- and Minecraft version.
     */
     ...
     * @author Griefed
     * @param forgeVersion {@link String} Forge version.
     * @return {@link String} Minecraft version for the given Forge version, wrapped in an {@link Optional}.
     */
    ...
    /**
     * Get a {@link ForgeInstance} for a given Minecraft and Forge version, wrapped in an {@link Optional}.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @param forgeVersion {@link String} Forge version.
     * @return {@link ForgeInstance} for the given Minecraft and Forge version, wrapped in an {@link Optional}
     */
    public Optional<ForgeInstance> getForgeInstance(String minecraftVersion, String forgeVersion) {
        return Optional.ofNullable(forgeLoader.instanceMeta().get(minecraftVersion + "-" + forgeVersion));
    }
    ...
    /**
     * Get a list of all available {@link ForgeInstance} for a given Minecraft version, wrapped in an {@link Optional}
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
    ...
    public Optional<List<ForgeInstance>> getForgeInstances(String minecraftVersion) {
        ...
        if (Optional.ofNullable(forgeLoader.versionMeta().get(minecraftVersion)).isPresent()) {
            ...
            forgeLoader.versionMeta().get(minecraftVersion).forEach(forgeVersion -> {
     ...
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String} Latest Forge version for the given Minecraft version, wrapped in an {@link Optional}
     */
     ...
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String} Oldest Forge version for the given Minecraft version, wrapped in {@link Optional}
     */
    ...
    /**
     * Get a list of available Forge version for a given Minecraft version, in {@link Type#ASCENDING} order, wrapped in an {@link Optional}.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String}-list of available Forge versions for the given Minecraft version, in ascending order, wrapped in an {@link Optional}
     */
    ...
    /**
     * Get a list of available Forge version for a given Minecraft version, in {@link Type#DESCENDING} order, wrapped in an {@link Optional}.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String}-list of available Forge versions for the given Minecraft version, in descending order, wrapped in an {@link Optional}
     */
    ...
    /**
     * Get an array of available Forge version for a given Minecraft version, in {@link Type#ASCENDING} order, wrapped in an {@link Optional}.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String}-array of available Forge versions for the given Minecraft version, in ascending order, wrapped in an {@link Optional}
     */
    ...
    /**
     * Get an array of available Forge version for a given Minecraft version, in {@link Type#DESCENDING} order, wrapped in an {@link Optional}.
     * @author Griefed
     * @param minecraftVersion {@link String} Minecraft version.
     * @return {@link String}-array of available Forge versions for the given Minecraft version, in descending order, wrapped in an {@link Optional}
     */
     ...
     * @author Griefed
     * @param forgeVersion {@link String} Forge version.
     * @return {@link URL} Forge server installer URL for the given Forge version, wrapped in an {@link Optional}.
     */
