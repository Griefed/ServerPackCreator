...
/**
 * Menu item which opens the ServerPackCreator GitHub page in the users' browser.
 *
 * @author Griefed
 */
class GitHubPageItem(private val webUtilities: WebUtilities) : JMenuItem(Translations.menubar_gui_menuitem_releases.toString()) {
