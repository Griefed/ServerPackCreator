...
11. **Plugins!**
    ...
    - An example plugin can be found at [the Example Plugin Repository](https://github.com/Griefed/ServerPackCreatorExampleAddon). It has simple examples for every possible addon and extension in ServerPackCreator
...
The plugins-section shows an excerpt from the README of the example plugin README. Check out the repository of the example addon, linked below,
for more details.

## 5.1. Example Plugin for ServerPackCreator

There is an example plugin available at [ServerPackCreator Example Plugin](https://github.com/Griefed/ServerPackCreatorExampleAddon)
...
## 5.3 The reason for allowing ServerPackCreator to run plugins:
...
or [ServerPackCreatorPluginExample](https://github.com/Griefed/ServerPackCreatorExampleAddon/issues/new?assignees=&labels=&template=documentation-request.md), using the Documentation template.

For an plugin to be accepted, you must at least provide:
