...
internal class ServerPackHandlerTest {
    ...
    fun neoForgeTest() {
        ...
        Assertions.assertTrue(File(neoForgeDir, "libraries").isDirectory)
        ...
        Assertions.assertFalse(File(modsDir, "Ping-1.11.1-2.22.2.jar").isFile)
        Assertions.assertTrue(File(modsDir, "Ping-wheel-1.11.1-2.22.2.jar").isFile)
