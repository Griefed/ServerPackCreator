...
/**
 * Status icon for server.properties inclusion to inform a user about the status of the specified properties and display
 * any encountered errors in a hover-tooltip.
 *
 * @author Griefed
 */
class IncludePropertiesInfo(guiProps: GuiProps) : StatusIcon(
    guiProps,
