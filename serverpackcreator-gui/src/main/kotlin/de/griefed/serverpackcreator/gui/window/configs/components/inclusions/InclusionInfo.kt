...
/**
 * Status icon for inclusion-filter to inform a user about the status of the specified filter and display
...
class InclusionInfo(guiProps: GuiProps) : StatusIcon(
    guiProps,
    Gui.createserverpack_gui_inclusions_editor_inclusion_info.toString()
)