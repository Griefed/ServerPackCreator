 ...
 * @author Griefed
 */
class DefaultServerIconItem(private val fileUtilities: FileUtilities,apiProperties: ApiProperties): JMenuItem(Gui.menubar_gui_menuitem_servericon.toString()) {
